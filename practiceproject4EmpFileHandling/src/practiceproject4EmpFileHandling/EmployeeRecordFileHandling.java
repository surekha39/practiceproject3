package practiceproject4EmpFileHandling;
...
public class EmployeeRecordFileHandling {
	...
	private static Scanner strInput;
	private static Scanner strInput2;
	private static Scanner strInput3;
	private static Scanner strInput4;
	private static Scanner strInput5;
	...
	public static void main(String[] args) {
	  ...
	  public static void AddRecord() throws IOException {
  		...
  		strInput2 = new Scanner(System.in);
  		
  		String ID, name, age, addr;
  		
  		System.out.print("Enter the Employee ID: ");
  		ID = strInput2.nextLine();
  		System.out.print("Enter the Employee Name: ");
  		name = strInput2.nextLine();
  		System.out.print("Enter the Employee Age: ");
  		age = strInput2.nextLine();
  		System.out.print("Enter the Employee Address: ");
  		addr = strInput2.nextLine();    		
	...
	public static void DeleteRecordByID() throws IOException {
	    		strInput3 = new Scanner(System.in);
	    		String ID, record;
	...
	public static void SearchRecordbyID() throws IOException {
	    		String ID,record;
	    		strInput5 = new Scanner(System.in);
	...
	public static void updateRecordbyID() throws IOException {
	    		...
	    		strInput4 = new Scanner(System.in);
	    		
	    		System.out.println("\t\t Update Employee Record\n\n");   
			/**/		
				System.out.println("Enter the Employee ID: ");
		    		ID = strInput4.nextLine();	    		
		    		System.out.println(" ------------------------------------------------------------- ");
		    		System.out.println("|	ID		Name 				Age			Address 		  |");
		    		System.out.println(" ------------------------------------------------------------- ");
			...
			/**/    	   
	    		...
	    		newName = strInput4.nextLine();    		
	    		System.out.println("Enter the new Age: ");
	    		newAge = strInput4.nextLine();  
	    		System.out.println("Enter the new Address: ");
	    		newAddr = strInput4.nextLine();  
